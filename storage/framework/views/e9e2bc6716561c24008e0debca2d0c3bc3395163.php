  ...
  <form method="POST" action="route('calculator')">
    <div class="d-flex flex-column">
      <div class="d-flex flex-column bg-body rounded p-2">
        ...
        <div class="d-flex rounded bg-light p-3">
          <div class="col-8">
            <div class="d-flex flex-column">
                ...
                <lable class="form-label mt-2"><b>Итого валовка, тонн в сутки:</b></lable>
            </div>
          </div>
          <div class="col-4">
            <div class="d-flex flex-column">
                <input class="form-control mt-2" placeholder="3123"/>
                <input class="form-control mt-2" placeholder="3123"/>
                <input class="form-control mt-2" placeholder="3123"/>
                <lable class="form-label mt-2 text-center"><b>Итого</b></lable>
            </div>
          </div>
        </div>
      </div>
      <div class="d-flex flex-column bg-body rounded p-1">
        ...
        <div class="d-flex rounded bg-light p-3">
          <div class="col-8">
            <div class="d-flex flex-column">
                ...
                <lable class="form-label mt-2"><b>Необходимая производительность сушилки номинальная</b></lable>
            </div>
          </div>
          <div class="col-4">
            <div class="d-flex flex-column">
        ...
        <div class="d-flex rounded bg-light p-3">
          <div class="col-8">
            <div class="d-flex flex-column">
                ...
                <lable class="form-label mt-2"><b>Производительность НОМИНАЛЬНАЯ</b></lable>
            </div>
          </div>
          <div class="col-4">
            <div class="d-flex flex-column">
        ...
        <div class="d-flex rounded bg-light p-3">
          <div class="col-8">
            <div class="d-flex flex-column">
                ...
                <lable class="form-label mt-2">Входная влажность, %</lable>
                <lable class="form-label mt-3">Выходная влажность, %</lable>
                <lable class="form-label mt-3"><b>Производительность физическая по культуре, тонн в час</b></lable>
            </div>
          </div>
          <div class="col-4">
            <div class="d-flex flex-column">
...
<?php /**PATH /Users/adm/testing/resources/views/includes/calculator/index.blade.php ENDPATH**/ ?>